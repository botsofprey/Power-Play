...
public class CoordinateLocations {
   ...
   public Pose2d leftStart = new Pose2d(40.5, 63.5, Math.toRadians(270)), //Quadrant 1 and 3 ***was 36***
                 rightStart = new Pose2d(-31, 63.5, Math.toRadians(270)); //Quadrant 2 and 4
