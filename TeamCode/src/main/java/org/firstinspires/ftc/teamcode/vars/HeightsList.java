...
public class HeightsList { //heights are all in tics
     ...
     */
    midJunction = (int) Math.round(685 * ratio), /**
     ...
     */
    groundJunction = (int) Math.round(125 * ratio);
     ...
     */
    fourConeStack = (int) Math.round(100 * ratio), /**
     ...
     */
    threeConeStack = (int) Math.round(95 * ratio), /**
