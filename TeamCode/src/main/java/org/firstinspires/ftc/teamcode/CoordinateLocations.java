...
public class CoordinateLocations {
   ...
   Pose2d rightBlueStart = new Pose2d(-0, startY, 180); //Quadrant 2
   Pose2d leftRedStart = new Pose2d(-0, -startY, 0); //Quadrant 3
   Pose2d rightRedStart = new Pose2d(0, -startY, 0); //Quadrant 4
